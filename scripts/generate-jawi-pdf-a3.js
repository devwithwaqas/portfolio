...
(async () => {
  try {
    ...
    // Set viewport to match A3 landscape (297mm x 420mm = 1123px x 1587px at 96 DPI)
    ...
    // Generate A3 PDF
    const pdfPath = path.join(__dirname, '..', 'public', 'jawi-kad-dalil-a3.pdf');
    await page.pdf({
      path: pdfPath,
      format: 'A3',
      landscape: true,
    ...
    console.log(`\n✅ A3 PDF generated successfully at: ${pdfPath}`);
