/**
 * SIMPLE BAT ANALYSIS
 * Find all coordinate patterns in the narration file
 */

const fs = require('fs');

console.log('SIMPLE BAT ANALYSIS');
console.log('=' * 80);
...
console.log('FINDING ALL COORDINATES:');
console.log('=' * 80);
...
console.log('\nPROBLEM IDENTIFIED:');
console.log('=' * 80);
console.log('1. Too many full diagram highlights');
console.log('2. Many duplicate coordinates');
console.log('3. Steps are highlighting wrong components');
console.log('4. Need to map each step to its correct individual component');
