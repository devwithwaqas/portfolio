...
console.log('FIXING REMAINING DUPLICATE HIGHLIGHTS');
...
console.log(`Found ${beforeCount} remaining duplicate highlights patterns`);
...
console.log('='.repeat(80));
console.log(`🎯 FIXED ${beforeCount - afterCount} REMAINING DUPLICATE HIGHLIGHTS!`);
