...
(function () {
                    // ===== LEGACY SYSTEM DISABLED - Using unified services =====
                    console.log('Legacy hx-inline system disabled - using unified HighlightService and NarrationService');
                    return; // Exit early to disable all legacy functionality
                    (function () {
                      ...
                      // devicon (optional)
                      (function () { if (!document.querySelector('link[href*="devicon.min.css"]')) { var l = document.createElement('link'); l.rel = 'stylesheet'; l.href = 'https://cdnjs.cloudflare.com/ajax/libs/devicons/1.8.0/css/devicons.min.css'; l.crossOrigin = 'anonymous'; document.head.appendChild(l); } })();
                      ...
                      function clearNodeHighlight() { if (!svgEl) return; svgEl.querySelectorAll('.hx-focus, .hx-narrate-focus').forEach(function (n) { n.classList.remove('hx-focus', 'hx-narrate-focus'); }); hideSvgFocusRect(); setFocusTarget(null); }
