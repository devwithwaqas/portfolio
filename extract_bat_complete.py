...
Handle the fact that the SVG is all on one line
"""
...
def main():
    ...
    with open('bat_complete_components_data.json', 'w') as f:
        json.dump(output_data, f, indent=2)
    
    print(f"\nData saved to bat_complete_components_data.json")
