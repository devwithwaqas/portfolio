#!/usr/bin/env python3
"""
Create simple visual verification page with HTML/CSS component representations
"""
...
def generate_visual_verification_html(data):
    """Generate HTML with visual component representations using CSS"""
    html_content = f"""
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        ...
        <div class="verification-form">
            ...
            <ol>
                ...
                <li>Compare it with the actual BAT diagram in your browser</li>
...
"""
    ...
    for i, component in enumerate(data.get('components', [])):
        component_type = component.get('type', 'rectangle')
        component_text = component.get('text', component.get('title', 'Component'))
        
        # Create visual representation class
        visual_class = f"visual-{component_type}"
        
        html_content += f"""
                <div class="component-card {component_type}" id="card_{i}">
                    ...
                    <div class="visual-representation">
                        ...
                        <div class="component-visual">
                            <div class="{visual_class}">
                                {component_text[:50]}{'...' if len(component_text) > 50 else ''}
                            </div>
                        </div>
                    </div>
                    
                    <div style="color: #666; margin-bottom: 10px;">Type: {component_type.title()}</div>
...
def main():
    print("🔍 Creating visual verification page with component representations...")
