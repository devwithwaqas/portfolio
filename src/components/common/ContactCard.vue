      ...
      <a :href="link" class="contact-card-link" :target="link.startsWith('http') ? '_blank' : '_self'">
        <div class="elegant-card">
          ...
          <div class="icon-container">
            <i :class="iconClass + ' main-icon icon-3xl'" :style="iconStyle"></i>
          </div>
...
.icon-container {
  position: relative;
  z-index: 10;
  /* Custom size for large decorative container - larger than standard icon sizes */
  width: 120px;
  height: 120px;
  border-radius: 16px;
...
@media (pointer: coarse) and (max-width: 768px) {
  ...
  /* Custom size for large decorative container */
  .icon-container {
    width: 100px;
    height: 100px;
  }
  
  /* Wrapper/icon sizes managed by standardized classes in template */
}
