          ...
          <div class="content-section">
            ...
            <div class="action-section">
              <div class="epic-buttons">
                <a :href="bannerImage" data-gallery="portfolio-gallery" class="glightbox button preview-btn">
                  <span class="button_lg">
                    <span class="button_sl"></span>
                    <span class="button_text">Preview</span>
                  </span>
                </a>
                <a :href="detailsLink" title="More Details" class="button details-btn">
                  <span class="button_lg">
                    <span class="button_sl"></span>
        ...
        if (card && borderOverlay && cardWrapper) {
            ...
            card.addEventListener('touchstart', (e) => {
              ...
              if (tapInterval < 300 && tapInterval > 0) {
                // Double-tap: do nothing, let single-tap logic handle it
                return
              }
              
              vm.lastTapTime = currentTime
              
              // Toggle animation on single tap
...
/* Responsive built-with-text sizing */
