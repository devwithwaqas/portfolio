/**
 * CREATE COMPLETE BAT NARRATION
 * Create ALL steps including individual shapes, groups, and architecture overviews
 */

const fs = require('fs');

console.log('CREATING COMPLETE BAT NARRATION');
console.log('=' * 80);

// Read the component mapping
const componentMapping = JSON.parse(fs.readFileSync('bat_component_mapping.json', 'utf8'));

// Create the COMPLETE BAT narration with ALL steps
const completeBatNarration = `// ========================================
...
export const batNarrationSteps = [
  ...
  // ========================================
  // 3. FRONTEND LAYER GROUP (4 steps)
  // ========================================
  {
    "title": "Frontend Layer - User Interface Components",
    "speechTitle": "Frontend Layer - User Interface Components",
    "description": "Complete frontend layer with all user interface components",
    "speechDescription": "The Frontend Layer encompasses all user interface components, providing comprehensive access to enterprise systems through multiple interfaces including desktop portals, mobile applications, and administrative dashboards.",
    "icon": "frontend.svg",
    "position": {
      "x": 0,
      "y": 0
  ...
  // ========================================
  // 4. API GATEWAY LAYER GROUP (4 steps)
  // ========================================
  {
    "title": "API Gateway Layer - Enterprise API Management",
    "speechTitle": "API Gateway Layer - Enterprise API Management",
    "description": "Complete API gateway layer with security and routing",
    "speechDescription": "The API Gateway Layer provides comprehensive enterprise API management, including advanced routing, security, load balancing, and authentication. It ensures secure communication between all microservices and external systems.",
    "icon": "api.svg",
    "position": {
      "x": 0,
      "y": 0
  ...
  // ========================================
  // 5. MICROSERVICES LAYER GROUP (10 steps)
  // ========================================
  {
    "title": "Microservices Layer - Business Logic Services",
    "speechTitle": "Microservices Layer - Business Logic Services",
    "description": "Complete microservices layer with all business logic services",
    "speechDescription": "The Microservices Layer encompasses all business logic services, providing comprehensive functionality for HR management, IT services, analytics, integration, notifications, and system management. Each service is independently scalable and maintainable.",
  ...
  // ========================================
  // 6. AZURE SERVICES LAYER GROUP (8 steps)
  // ========================================
  {
    "title": "Azure Services Layer - Cloud Infrastructure",
    "speechTitle": "Azure Services Layer - Cloud Infrastructure",
    "description": "Complete Azure services layer with cloud infrastructure",
    "speechDescription": "The Azure Services Layer provides comprehensive cloud infrastructure capabilities, including message queuing, event processing, serverless computing, real-time analytics, monitoring, and business intelligence. It ensures scalable and reliable cloud operations.",
    "icon": "azure.svg",
    "position": {
      "x": 0,
      "y": 0
  ...
  // ========================================
  // 7. DATABASE LAYER GROUP (2 steps)
  // ========================================
  {
    "title": "Database Layer - Data Storage & Management",
    "speechTitle": "Database Layer - Data Storage & Management",
    "description": "Complete database layer with transactional and document storage",
    "speechDescription": "The Database Layer provides comprehensive data storage and management capabilities, including transactional databases for critical business data and NoSQL document storage for flexible data models. It ensures data consistency, availability, and performance.",
    "icon": "database.svg",
    "position": {
      "x": 0,
      "y": 0
  ...
  // ========================================
  // 8. EXTERNAL SYSTEMS LAYER GROUP (9 steps)
  // ========================================
  {
    "title": "External Systems Layer - Enterprise Integrations",
    "speechTitle": "External Systems Layer - Enterprise Integrations",
    "description": "Complete external systems layer with enterprise integrations",
    "speechDescription": "The External Systems Layer encompasses all enterprise system integrations, including SAP ERP, Cherwell HR/IT, Microsoft 365 services, and other third-party systems. It ensures seamless data flow and business process integration.",
    "icon": "external.svg",
    "position": {
      "x": 0,
      "y": 0
  ...
  // ========================================
  // 9. SYSTEM INTEGRATION & DATA FLOW
  // ========================================
  {
  ...
  // ========================================
  // 10. ENTERPRISE ARCHITECTURE SUMMARY
  // ========================================
  {
...
fs.writeFileSync('src/config/batNarration.js', completeBatNarration, 'utf8');

console.log('COMPLETE BAT NARRATION CREATED!');
console.log('=' * 80);
console.log('Total steps: 60+ (including all groups and individual components)');
console.log('File created: src/config/batNarration.js');
console.log('The BAT page now has the COMPLETE narration with all groups and individual components!');
